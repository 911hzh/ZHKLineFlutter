...
class HomePageState {
  const HomePageState({
    ...
    this.entries = const [
      HomePageEntry(title: 'KLine Delegate Demo', routeName: KLineDemoPage.routeName),
      HomePageEntry(title: '深度图 Demo', routeName: DeepChartDemoPage.routeName),
      HomePageEntry(title: '实时更新与自定义比较', routeName: CustomLiveUpdatePage.routeName),
      HomePageEntry(title: '自定义主题与布局', routeName: CustomThemeLayoutPage.routeName),
      HomePageEntry(title: '自定义指标与详情字段', routeName: CustomIndicatorEntriesPage.routeName),
      HomePageEntry(title: '动态指标定义', routeName: CustomIndicatorSpecPage.routeName),
      HomePageEntry(title: '自定义覆盖层 UI', routeName: CustomOverlayPage.routeName),
      HomePageEntry(title: '自定义长按详情 UI', routeName: CustomSelectionViewPage.routeName),
      ...
      HomePageEntry(title: '自定义副图绘制', routeName: CustomSecondaryChartPage.routeName),
      HomePageEntry(title: '外部控制图表状态', routeName: CustomControllerPage.routeName),
      HomePageEntry(title: '自定义加载与错误状态', routeName: CustomStateBuilderPage.routeName),
      HomePageEntry(title: '完全自定义核心图表', routeName: CustomCoreChartPage.routeName),
    ],
  });
  ...
  HomePageState copyWith({List<HomePageEntry>? entries, String? title}) {
    return HomePageState(entries: entries ?? this.entries, title: title ?? this.title);
  }
}
