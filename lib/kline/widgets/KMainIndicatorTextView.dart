              ...
              values: [
                if (indicators.ma5 != null)
                  _IndicatorValue(
                    ...
                    color: config.ma5Color,
                  ),
                if (indicators.ma10 != null)
                  _IndicatorValue(
                    name: 'MA10',
                    value: indicators.ma10!,
                    color: config.ma10Color,
                  ),
                if (indicators.ma30 != null)
                  _IndicatorValue(
                    name: 'MA30',
                    value: indicators.ma30!,
                    color: config.ma30Color,
                  ),
              ],
            ),
            ...
            _buildIndicatorRow(
              values: [
                if (indicators.ema5 != null)
                  _IndicatorValue(
                    name: 'EMA5',
                    value: indicators.ema5!,
                    color: config.ema5Color,
                  ),
                if (indicators.ema10 != null)
                  _IndicatorValue(
                    name: 'EMA10',
                    value: indicators.ema10!,
                    color: config.ema10Color,
                  ),
                if (indicators.ema30 != null)
                  _IndicatorValue(
                    name: 'EMA30',
                    value: indicators.ema30!,
                    color: config.ema30Color,
                  ),
              ],
            ),
            ...
            _buildIndicatorRow(
              values: [
                if (indicators.bollUpper != null)
                  _IndicatorValue(
                    name: 'UPPER',
                    value: indicators.bollUpper!,
                    color: config.bollUpperColor,
                  ),
                if (indicators.bollMiddle != null)
                  _IndicatorValue(
                    name: 'MB',
                    value: indicators.bollMiddle!,
                    color: config.bollMiddleColor,
                  ),
                if (indicators.bollLower != null)
                  _IndicatorValue(
                    name: 'LOWER',
                    value: indicators.bollLower!,
                    color: config.bollLowerColor,
                  ),
              ],
            ),
        ],
